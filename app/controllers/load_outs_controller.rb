class LoadOutsController < ApplicationController
  ...
  def strong_params
    ...
    :t1_customer_id, :status, :departure_date, :truck_nr, :trailer_nr, :type_of_service,:note, :trip_ref, :out_assignments_attributes => [ :packer, :lot_nr,:number_of_boxe,:number_of_pallet,:net_weight, :incoming_order_ref,:incoming_transport_ref, :other_ref,:cost, :div_cost]
  )
  end
